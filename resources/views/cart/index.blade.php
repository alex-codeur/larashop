        ...
        <div class="px-4 px-lg-0">
            ...
            <div class="pb-5">
                            ...
                            @foreach(Cart::content() as $product)
                                <tr>
                                    <th scope="row" class="border-0">
                                        <div class="p-2">
                                            <img alt="" width="70" class="img-fluid rounded shadow-sm" src="{{ asset('storage/' . $product->model->image) }}">
                ...
                <div class="row py-5 p-4 bg-white rounded shadow-sm">
                    ...
                    <div class="p-4">
                        <p class="font-italic mb-4">Les frais éventuels de livraison seront calculés suivant les informations que vous transmises.</p>
                        ...
                        @endif
                        </ul><a href="{{ route('checkout.index') }}" class="btn btn-dark rounded-pill py-2 btn-block"><i class="fas fa-money-check mr-2 "></i>Passer à la caisse</a>
                    </div>
                    </div>
                </div>
